...
public class AdaptadorDomestica extends RecyclerView.Adapter<AdaptadorDomestica.ViewHolder>   {
    ...
    public AdaptadorDomestica(EscuchaEventosClick escucha) {
        this.escucha = escucha;
    }
    @Override
    public int getItemCount() {
        return Animales.ANIMALES_CASEROS.size();
    }
   ...
   /* private  AdaptadorCategorias(List<Animales> items) {
    ...
    public void onBindViewHolder(ViewHolder viewHolder, int i) {
        Animales item = Animales.ANIMALES_CASEROS.get(i);
